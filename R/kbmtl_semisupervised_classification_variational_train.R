#' kbmtl_semisupervised_classification_variational_train
#'
#' @param K (matrix) matrix
#' @param Y (matrix) matrix
#' @param parameters (vector)
#' @return state
#' @export
#' @author Mehmet Gonen
#' @examples state <-kbmtl_semisupervised_classification_variational_train(K_train, Y_train,parameters)
